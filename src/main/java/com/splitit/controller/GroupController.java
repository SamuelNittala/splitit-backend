...
public class GroupController {
	...
	@PostMapping("/add")
	public ResponseEntity<?> addMembersInGroup(@RequestBody AddUserToGroupDto userGroupRequestDto) {
		groupService.addMembersInGroup(userGroupRequestDto);
		Map<String, String> response = new HashMap<>();
		response.put("success", "added " + userGroupRequestDto.getPhoneNumbers() + " numbers");
		return ResponseEntity.ok(response);
	}
